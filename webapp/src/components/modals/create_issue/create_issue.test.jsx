...
jest.mock('@/components/forgejo_repo_selector', () => ({
    __esModule: true,
...
jest.mock('@/components/forgejo_label_selector', () => ({
    __esModule: true,
    default: () => <div data-testid='github-label-selector'>{'Label Selector'}</div>,
}));

jest.mock('@/components/forgejo_assignee_selector', () => ({
    __esModule: true,
    default: () => <div data-testid='github-assignee-selector'>{'Assignee Selector'}</div>,
}));

jest.mock('@/components/forgejo_milestone_selector', () => ({
    __esModule: true,
...
test('CreateIssueModal should render correctly with default props', () => {
    ...
    expect(screen.getByText('Create Forgejo Issue')).toBeInTheDocument();
...
test('CreateIssueModal should call create prop when form is submitted with valid data', async () => {
    ...
    const titleInput = screen.getByRole('textbox', {name: /title for the forgejo issue/i});
