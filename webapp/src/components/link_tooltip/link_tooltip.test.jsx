...
test('LinkTooltip should default to the configured Forgejo instance for opened by link if no enterpriseURL and no html_url', async () => {
    Client.getIssue.mockResolvedValueOnce({
        id: 1,
        title: 'Test Issue',
        body: 'Description',
    ...
    expect(link).toHaveAttribute('href', 'https://forgejo.pyn.ru/clouduser');
});
