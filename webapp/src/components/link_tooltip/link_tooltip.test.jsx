...
describe('LinkTooltip', () => {
    ...
    test('should default to the configured Forgejo instance for opened by link if no enterpriseURL and no html_url', async () => {
        Client.getIssue.mockResolvedValueOnce({
            id: 1,
            title: 'Test Issue',
            body: 'Description',
        ...
        const link = wrapper.find('.opened-by a');
        expect(link.prop('href')).toBe('https://forgejo.pyn.ru/clouduser');
    });
});
